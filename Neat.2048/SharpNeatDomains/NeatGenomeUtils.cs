...
namespace SharpNeat.Domains
{
    ...
    public static class NeatGenomeUtils
    {
        ...
        public static List<NeatGenome> LoadPopulation(XmlReader xr, bool nodeFnIds, int inputCount, int outputCount, IGenomeFactory<NeatGenome> factory)
        {
            // Load genomes. Reading node IDs is not necessary for NEAT.
            List<NeatGenome> genomeList = NeatGenomeXmlIO.ReadCompleteGenomeList(xr, nodeFnIds, factory as NeatGenomeFactory);
