...
namespace SharpNeat.Domains.BoxesVisualDiscrimination
{
    ...
    public class BoxesVisualDiscriminationExperiment : IGuiNeatExperiment
    {
        ...
        {
            return NeatGenomeUtils.LoadPopulation(xr, true, this.InputCount, this.OutputCount, CreateGenomeFactory());
        }
        ...
        public NeatEvolutionAlgorithm<NeatGenome> CreateEvolutionAlgorithm(IGenomeFactory<NeatGenome> genomeFactory, List<NeatGenome> genomeList)
        {
            ...
            IGenomeListEvaluator<NeatGenome> innerEvaluator =
                ...
                //new ParallelGenomeListEvaluator<NeatGenome, IBlackBox>(genomeDecoder, evaluator, _parallelOptions);
